...
fn create_animations(
    ...
    handles.fast =
        assets.add(SpriteSheetAnimation::from_range(0..=4, Duration::from_millis(100)).once());
    handles.slow =
        assets.add(SpriteSheetAnimation::from_range(0..=4, Duration::from_millis(250)).once());
}
